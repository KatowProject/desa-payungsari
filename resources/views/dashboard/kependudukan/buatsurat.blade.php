  ...
  <div class="card-body">
    ...
    <form action="{{ url('buatsurat/skdd') }}" method="post" target="_blank">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control form-control-sm" id="nama" placeholder="" name="jenis_kelamin" value="{{ $p->jenis_kelamin }}">
        </div>
      </div>
      <div class="row mb-2">
  ...
  <div class="card-body">
    ...
    <form action="{{ url('buatsurat/sku') }}" method="post" target="_blank">
      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-10">
          <input type="text" class="form-control form-control-sm" id="jenis_usaha" placeholder="" name="alamat_usaha" value="{{ $p->alamat }}">
        </div>
      </div>
      <div class="row mb-2">
...
<div class="card" id="formsktm" style="display: none;">
  <div class="card-body">
    <h4 class="card-title">Form Surat Percobaan</h4>
