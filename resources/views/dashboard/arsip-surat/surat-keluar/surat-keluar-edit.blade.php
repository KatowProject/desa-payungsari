...
@if (Request::session()->has('surat_keluar_update'))
<script>
Swal.fire({
  icon: 'success',
...
<?php Request::session()->forget('surat_keluar_update'); ?>
@endif


<div class="card">
  <div>
    <a href="{{ url('surat-keluar') }}" class="btn btn-danger btn-back">Kembali</a>
  </div>
    <h2 class="card-title px-4">Form Edit Surat keluar</h2>
        <div class="card-body">
            <form action="{{ url('surat-keluar/'.$data->id ) }}" method="POST" enctype="multipart/form-data" class="row g-3">
                @method('put')
                @csrf
                <div class="col-md-12">
                  <div class="col-md-1">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="tanggal_dikirim" name="tanggal_dikirim" value="{{ old('tanggal_dikirim', $data->tanggal_dikirim) }}" autocomplete="off">
                  </div>
                  <div class="col-12">
                  ...
                  <div class="col-12">
                    ...
                    <input type="text" class="form-control" id="tujuan_surat" name="tujuan_surat" value="{{ old('tujuan_surat', $data->tujuan_surat) }}" autocomplete="off">
                  </div>
                  <div class="col-md-6">
